    ...
    <IonPage>
      <IonContent>
        <div className={`container ${expanded ? "expanded" : ""}`}>
          ...
          <IonButtons
            className={`downArrow ${expanded ? "upIcon" : "downIcon"}`}
          >
            ...
            >
              {showContent && (
                <div className="scrollable-content">
                  ...
                  <div className="total-stacked">
                    <IonList className="total-stacked-item ion-text-start">
                      <IonLabel>11,281,511,023 BLV</IonLabel>
                      <br />
                      <IonText>Total Withdrawals</IonText>
                    </IonList>
                    <IonList className="total-stacked-item ion-text-end">
                      <IonLabel>$2,256,302,205</IonLabel>
                      <br />
        ...
        <div className="body">
          {expanded ? null : (
            <IonGrid>
              {showItem ? null : (
                <IonRow
                  className="ion-margin-top baby-items"
                  style={{ alignItems: "center" }}
                >
                  <IonCol
                    className="addReferral"
                    size="6"
                    sizeMd="6"
                    sizeLg="6"
                    sizeXl="6"
                  >
                    <IonButtons>
                      <IonButton>
                        <IonIcon
                          className="addPerson icons"
                          size="medium"
                          icon={personAdd}
                        />
                        <IonLabel className="addReferralColor">
                          Add Referral
                        </IonLabel>
                      </IonButton>
                    </IonButtons>
