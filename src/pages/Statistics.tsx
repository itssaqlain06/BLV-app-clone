...
import { arrowDownCircleOutline, arrowUpCircleOutline, list, listSharp, logoWhatsapp } from 'ionicons/icons';
            ...
            <IonContent className="ion-padding">
                    ...
                    <IonGrid>
                        ...
                        <IonRow>
                            <IonCol className='small-text'>
                                This is the amount of rewards that you can withdraw to your main wallet.
                            </IonCol>
                        </IonRow>
                ...
                <div className="stat-container avail">
                    <IonGrid>
                        ...
                        <IonRow>
                            <IonCol className='small-text'>
                                This is the 5x Multiple of your staked amount, and includes staking rewards, direct rewards and team rewards.
                            </IonCol>
                        </IonRow>
                ...
                <div className="stat-container available">
                    <IonGrid>
                        ...
                        <IonRow>
                            <IonCol className='small-text'>
                                This is the amount of rewards that you can receive after deducting already earned rewards from the maximum.
                            </IonCol>
                        </IonRow>
                    </IonGrid>
                </div>
